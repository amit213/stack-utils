...
sudo apt-get update -y;
sudo apt-get install juju-local qemu-kvm libvirt-bin bridge-utils virt-manager qemu-system uvtool-libvirt uvtool nfs-kernel-server qemu-utils nfs-common -y;
